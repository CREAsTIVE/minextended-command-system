...
fun TextReader(other: TextReader): TextReader = TextReader(other.content, other.cursor)

class TextReader(val content: String, var cursor: Int = 0) {
    ...
    fun safeNext(): Char? = if (isEof()) null else next()
    ...
    infix fun copyFrom(other: TextReader): TextReader {
